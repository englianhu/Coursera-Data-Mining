...
```{r setup-sh}
tryCatch(system('cd data/Assignment_1; ./setup.sh'), error = function(err) print(err))
```
...
```{r search}
tryCatch(system('cd data/Assignment_1/build; ../../meta/build/interactive-search ../config.toml'), error = function(err) print(err))
```
...
![load package *plyr* error](figure/plyr-err.jpg)
