...
transDat <- read.transactions('https://raw.githubusercontent.com/englianhu/Coursera-Data-Mining/master/4%20Pattern%20Discovery%20in%20Data%20Mining/data/categories.txt')
```
...
```{r item1, echo = FALSE, results = 'asis'}
itemFrequencyPlot(transDat, topN = 20, type = 'absolute', col = rainbow(4))
```

*graph 2.1.1 : explore the top 20 items in the dataset.*
...
*graph 2.1.2 : top 10 items in dataset.*
