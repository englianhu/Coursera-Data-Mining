...
transDat <- suppressAll(read.transactions('https://raw.githubusercontent.com/englianhu/Coursera-Data-Mining/master/4%20Pattern%20Discovery%20in%20Data%20Mining/data/categories.txt', format = 'single', cols = c(1, 2), sep = ';'))

transDat2 <- suppressAll(read.transactions('https://raw.githubusercontent.com/englianhu/Coursera-Data-Mining/master/4%20Pattern%20Discovery%20in%20Data%20Mining/data/categories.txt', format = 'basket', sep = ';'))
```
